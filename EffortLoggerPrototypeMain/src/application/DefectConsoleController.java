...
public class DefectConsoleController extends Application {
	...
	public void start(Stage primaryStage) {
        ...
        vBox.getChildren().addAll(def, defectNumLabel, defectNumInput, defectNameLabel, defectNameInput, defectDesLabel, defectDescriptionInput, defectImpLabel, defectImportance, statLabel, statusUpdate, userName, userInput, add, addButton, remove, removeButton, update, updateButton, homeScreenButton);
